...
def loping(rest_id,user_name,tweet_text,cookies,reaction_limite,viwes_limite,comment_limite,nb_tweets):
    ...
    try:
        ...
        params = {
            'variables': '{"userId":"%s","count":50,"cursor":"%s","includePromotedContent":true,"withQuickPromoteEligibilityTweetFields":true,"withVoice":true,"withV2Timeline":true}'%(rest_id,cursor),
...
def loping_serch(tweet_text,cookies,reaction_limite,viwes_limite,comment_limite,nb_tweets,chatagory):
...
def main(type_search, keywords, reaction_limite,viwes_limite,comment_limite,nb_tweets):
    ...
    return tweets
ccc=main(type_search, keywords, reaction_limite,viwes_limite,comment_limite,nb_tweets)
print(ccc)
